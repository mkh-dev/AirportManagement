...
namespace AM.ApplicationCore
{
    public static class InMemorySource
    {
        ...
        public static readonly Staff CaptainStaff = new Staff { PassportNumber = "sp1", FirstName = "captain", LastName = "Captain", EmailAddress = "captain@gmail.com", BirthDate = new DateTime(1965, 1, 1), EmployementDate = new DateTime(1999, 1, 1), Salary = 10000, Flights = new List<Flight> {Flight1, Flight3 } };
        public static readonly Staff Hostess1Staff = new Staff { PassportNumber = "sp2", FirstName = "hostess1", LastName = "Hostess1", EmailAddress = "hostess1@gmail.com", BirthDate = new DateTime(1995, 1, 1), EmployementDate = new DateTime(2019, 1, 1), Salary = 5000, Flights = new List<Flight> { Flight1, Flight3 } };
        public static readonly Staff Hostess2Staff = new Staff { PassportNumber = "sp3", FirstName = "hostess2", LastName = "Hostess2", EmailAddress = "hostess2@gmail.com", BirthDate = new DateTime(1996, 1, 1), EmployementDate = new DateTime(2018, 1, 1), Salary = 6000, Flights = new List<Flight> { Flight1, Flight3 } };
        
        //traveller

        public static readonly Traveller Traveller1 = new Traveller { PassportNumber = "tp4", FirstName = "traveller1", LastName = "Traveller1", BirthDate = new DateTime(1980, 1, 1), HealthInformation = "No troubles", Nationality = "American", Flights = new List<Flight> { Flight2, Flight3 } };
        public static readonly Traveller Traveller2 = new Traveller { PassportNumber = "tp5", FirstName = "traveller2", LastName = "Traveller2", BirthDate = new DateTime(1981, 1, 1), HealthInformation = "Some troubles", Nationality = "French", Flights = new List<Flight> { Flight2, Flight3 } };
        public static readonly Traveller Traveller3 = new Traveller { PassportNumber = "tp6", FirstName = "traveller3", LastName = "Traveller3", BirthDate = new DateTime(1982, 1, 1), HealthInformation = "No troubles", Nationality = "Tunisian", Flights = new List<Flight> { Flight2, Flight3 } };
        public static readonly Traveller Traveller4 = new Traveller { PassportNumber = "tp7", FirstName = "traveller4", LastName = "Traveller4", BirthDate = new DateTime(1983, 1, 1), HealthInformation = "Some troubles", Nationality = "American", Flights = new List<Flight> { Flight2, Flight3 } };
        public static readonly Traveller Traveller5 = new Traveller { PassportNumber = "tp8", FirstName = "traveller5", LastName = "Traveller5", BirthDate = new DateTime(1984, 1, 1), HealthInformation = "Some troubles", Nationality = "Spanish", Flights = new List<Flight> { Flight2, Flight3 } };
